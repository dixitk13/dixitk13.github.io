(window.webpackJsonp = window.webpackJsonp || []).push([
  [3],
  {
    140: function(M, N, j) {
      ...
      var I = j(0),
        ...
        a = {
          ...
          mobile: "(min-width: " + e + ") and (max-width: " + u + ")",
          tablet: "(max-width: " + u + ")",
          laptop: "(max-width: " + z + ")",
          laptopL: "(max-width: " + "1440px" + ")",
          desktop: "(min-width: " + z + ") and (max-width: " + c + ")",
          desktopL: "(max-width: " + c + ")"
        },
        T = t.a.div.withConfig({
        ...
        y = function(M) {
          var N = M.children;
          return L.a.createElement(T, null, N);
        },
        n = j(7),
        A = j.n(n),
        C = j(171),
        ...
        t.a.div.withConfig({
          ...
          [
            ...
            ";max-height:0;min-height:0;overflow:hidden;margin-top:0;opacity:0;",
            ";@media ",
            "{width:",
            ";}"
          ],
        ...
        o = t.a.div.withConfig({
          displayName: "ExpandableCard__ExpanderBody",
          componentId: "sc-139ipyj-1"
        })(["font-size:", ";align-self:start;"], Object(D.a)(0.65)),
        E = t.a.div.withConfig({
          displayName: "ExpandableCard__ExpanderClose",
          componentId: "sc-139ipyj-2"
        })([
          'position:absolute;width:20px;height:20px;top:20px;right:20px;cursor:pointer;&:before,&:after{content:"";position:absolute;width:100%;top:50%;height:1px;background:#888;transform:rotate(45deg);}&:after{transform:rotate(-45deg);}&:hover:before,&:hover:after{background:#333;}'
        ]),
        l = t.a.div.withConfig({
        ...
        r = t.a.div.withConfig({
          ...
          [
            ...
            ";border-radius:",
            ";font-weight:",
            ";color:rgba(0,0,0,0.8);background:rgba(0,0,0,0.1);max-height:25px;white-space:nowrap;@media ",
        ...
        S = t.a.div.withConfig({
          ...
          [
            ...
            ";box-shadow:rgba(0,0,0,0.08) 0px 4px 8px;background-color:",
            ";@media ",
            "{&:nth-child(-n + ",
        ...
        d = t.a.div.withConfig({
          ...
          [
            ...
            ";border-radius:",
            ";min-height:",
            ";position:relative;cursor:pointer;text-align:center;display:flex;flex-direction:column;justify-content:start;transition:all 0.2s ease-in-out;background-color:",
        ...
        Y = t.a.div.withConfig({
          displayName: "ExpandableCard__Title",
          componentId: "sc-139ipyj-8"
        })(
          [
            "color:rgba(0,0,0,0.7);font-size:",
            ";cursor:pointer;font-weight:600;&:hover{color:rgba(0,0,0,0.5);}"
          ],
          Object(D.a)(0.75)
        ),
        m = t.a.div.withConfig({
          displayName: "ExpandableCard__OpenLink",
          componentId: "sc-139ipyj-9"
        })(
          [
            "margin-left:auto;font-size:",
            ";margin-top:-3px;cursor:pointer;height:30px;width:30px;padding:3px;&:hover{background:rgb(236,237,238);border-radius:3px;}"
          ],
          Object(D.a)(0.75)
        ),
        p = t.a.div.withConfig({
        ...
        H = (b.a,
        {
          ...
          react: U.a,
          graphql: Z.a,
          styledcomponents: f.a,
          "styled-components": f.a,
          webpack: B.a,
          babel: W.a,
          github: J.a
        }),
        ...
        fM = Object.assign({}, H, {
          ...
          hibernate: mM.a,
          reflections: kM.a,
          computerscience: QM.a,
          hat: hM.a,
          apollo: vM.a
        }),
        GM = t.a.img.withConfig({
        ...
        RM = function(M) {
          ...
          return L.a.createElement(
            ...
            L.a.createElement(
              ...
              L.a.createElement(WM, { images: t }),
              L.a.createElement(p, null, g)
            ),
            L.a.createElement(
              x,
              { open: u },
              L.a.createElement(E, {
                onClick: function(M) {
                  return (function(M, N) {
                    M.stopPropagation(), e(N);
                  })(M, N);
                }
              }),
              L.a.createElement(o, { dangerouslySetInnerHTML: { __html: D } }),
              L.a.createElement(
                l,
                null,
                i.map(function(M, N) {
        ...
        JM = (function(M) {
          ...
          return (
            ...
            (N.prototype.render = function() {
              return L.a.createElement(RM, this.props);
            }),
            N
          );
        })(I.Component),
        ...
        VM = t.a.div.withConfig({
          displayName: "ProjectsView__CardsContainer",
          componentId: "sc-1wki2uf-0"
        })(
          [
            "@media ",
            "{display:flex;flex-flow:row wrap;width:40vw;padding:0 10px 0 0px;height:100%;overflow:scroll;}@media ",
        ...
        FM = (function(M) {
          function N() {
            for (
              var N, j = arguments.length, I = new Array(j), L = 0;
              L < j;
              L++
            )
              I[L] = arguments[L];
          ...
          return (
            ...
            (N.prototype.render = function() {
              var M = this;
              return L.a.createElement(XM.StaticQuery, {
                query: KM,
                render: function(N) {
                  return L.a.createElement(HM, {
        ...
        zN = function(M) {
          var N = M.href,
            j = M.title,
            I = M.imgsrc,
            i = s()(M, ["href", "title", "imgsrc"]);
          return L.a.createElement(
            uN,
            { target: "_blank", href: N },
            I ? L.a.createElement(eN, Object.assign({ src: I }, i), j) : j
          );
        },
        cN = function() {
          var M = [
        ...
        AN = t.a.button.withConfig({
          displayName: "DownloadButtonsView__SimpleButton",
          componentId: "sc-1upcjj2-1"
        })(
          [
            "text-decoration:none;background:transparent;padding:0;height:21px;border:none;width:90px;cursor:pointer;margin:",
            ";font-size:",
        ...
        sN = function(M) {
          ...
          return L.a.createElement(
            ...
            L.a.createElement(
              nN,
              { download: !0, target: "_blank", href: yN.a },
              L.a.createElement(
                CN,
                {
                  type: "button",
                ...
                L.a.createElement("span", null, "Resume")
              )
            ),
            L.a.createElement(
              AN,
              null,
              L.a.createElement("span", { onClick: N }, "no-op")
            )
          );
        },
        xN = (function(M) {
          ...
          return (
            A()(N, M),
            (N.prototype.render = function() {
              return L.a.createElement(sN, { toggleOn: this.props.toggleOn });
            }),
            N
          );
        })(I.Component),
        ...
        mN = (function(M) {
          ...
          return (
            A()(N, M),
            (N.prototype.render = function() {
              return L.a.createElement(YN, null);
            }),
            N
          );
        })(I.Component),
        pN = t.a.div.withConfig({
        ...
        hN = function(M) {
          ...
          return L.a.createElement(
            ...
            L.a.createElement(
              ...
              L.a.createElement("label", { htmlFor: "toggle-heart" }, "❤")
            ),
            L.a.createElement(kN, { onClick: j }, "Dixit Keshavbhai Patel"),
            L.a.createElement(bN, { src: $M.a, alt: "Dixit" }),
            L.a.createElement(QN, null, "just another software engineer"),
            L.a.createElement(aN, null),
            L.a.createElement(xN, { toggleOn: j }),
      ...
      N.default = function(M) {
        ...
        return L.a.createElement(
          ...
          L.a.createElement(g.a, {
            ...
            link: [{ rel: "shortcut icon", type: "image/png", href: "" + fN.a }]
          }),
          L.a.createElement(ZN, null),
          L.a.createElement(qM, null)
        );
      };
      var GN = "1097489062";
    },
    ...
    150: function(M, N, j) {
      "use strict";
      j.r(N),
        j.d(N, "graphql", function() {
          return T;
        }),
        j.d(N, "StaticQueryContext", function() {
          return c;
        }),
        j.d(N, "StaticQuery", function() {
          return a;
        });
      var I = j(0),
        L = j.n(I),
      ...
      j.d(N, "Link", function() {
        ...
        j.d(N, "withPrefix", function() {
          return t.withPrefix;
        }),
        j.d(N, "navigate", function() {
          return t.navigate;
        }),
        j.d(N, "push", function() {
          return t.push;
        }),
        j.d(N, "replace", function() {
          return t.replace;
        }),
        j.d(N, "navigateTo", function() {
          return t.navigateTo;
        });
      var e = j(151),
        u = j.n(e);
      j.d(N, "PageRenderer", function() {
        return u.a;
      });
      var z = j(49);
      j.d(N, "parsePath", function() {
        return z.a;
      });
      var c = L.a.createContext({}),
        a = function(M) {
          return L.a.createElement(c.Consumer, null, function(N) {
    ...
    177: function(M, N, j) {
      M.exports = j.p + "static/styled-6d94f33ca2440979e0ba969184403335.png";
    },
    178: function(M, N) {
      M.exports =
    ...
    179: function(M, N, j) {
      M.exports = j.p + "static/babel-c38fdea3fe3acb33da85199d7a3abf15.svg";
    },
    180: function(M, N) {
      M.exports =
    ...
    182: function(M, N, j) {
      M.exports =
        j.p + "static/blueprintjs-62e148c14af6b4545ea7d9ef96c047e1.png";
    },
    183: function(M, N) {
      M.exports =
    ...
    187: function(M, N, j) {
      M.exports = j.p + "static/cra-c032f3240a8804ef2461d0b0b8e69cad.png";
    },
    188: function(M, N) {
      M.exports =
    ...
    189: function(M, N, j) {
      M.exports = j.p + "static/graph-823439e2918f09fe6a8ee5377307bc5f.png";
    },
    190: function(M, N, j) {
      M.exports = j.p + "static/java-29f24a5752457c20e30c42eba31e7334.png";
    },
    191: function(M, N, j) {
      M.exports = j.p + "static/pwa-33c3a22c05e810d2bb622d7edb27908a.png";
    },
    192: function(M, N, j) {
      M.exports = j.p + "static/linux-7ed8a808420a41cc91afa6236e7a1dd4.png";
    },
    193: function(M, N) {
      M.exports =
    ...
    196: function(M, N, j) {
      M.exports = j.p + "static/genesys-2fdc6c8fec42b4ccda930a2b12a2bb57.png";
    },
    197: function(M, N, j) {
      M.exports = j.p + "static/infosys-9a0f1bbb21616a2c67068e889d098c3c.svg";
    },
    198: function(M, N, j) {
      M.exports =
        j.p + "static/northeastern-7c9dec28046c720f740d81344cb3ebc4.png";
    },
    199: function(M, N) {
      M.exports =
    ...
    200: function(M, N, j) {
      M.exports =
        j.p + "static/reflections-f7821999576029210e329c8c98b89f23.png";
    },
    201: function(M, N, j) {
      M.exports =
        j.p + "static/computerscience-528f4450214098437fe797e024c919b9.png";
    },
    202: function(M, N, j) {
      M.exports = j.p + "static/hat-f14ff7d71755e97d484e43473cecc835.png";
    },
    203: function(M, N) {
      M.exports =
        "data:image/svg+xml;base64,";
    },
    205: function(M, N, j) {
      "use strict";
      j.r(N);
      ...
      var I = j(0),
        ...
        e = function(M) {
          var N = M.location,
            j = D.default.getResourcesForPathnameSync(N.pathname);
          return L.a.createElement(
            t.a,
            Object.assign({ location: N, pageResources: j }, j.json)
          );
        };
      (e.propTypes = {
    ...
    206: function(M, N, j) {
      M.exports = j.p + "static/dixitk13-34e056d5a67771f90b62e1f1ded49baf.jpg";
    },
    207: function(M, N) {
      M.exports =
    ...
    210: function(M, N, j) {
      M.exports = j.p + "static/github-5d292e21532ea5857531cdb8b0180637.jpg";
    },
    211: function(M, N, j) {
      M.exports =
        j.p +
    ...
    213: function(M, N, j) {
      M.exports = j.p + "static/favicon-db9e577a600d00ca64d458ed3fd1fff2.ico";
    }
  }
]);
//# sourceMappingURL=component---src-pages-index-js-f690b97001a8d479beef.js.map
