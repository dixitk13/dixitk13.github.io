...
The sieve of Eratosthenes is an algorithm for finding prime numbers up to
any given limit in a very clever manner. Please refer to [wikipedia](https://en.wikipedia.org/wiki/Sieve_of_Eratosthenes) for detailed
explaination.
