    ...
    137: function(M, N, i) {
      ...
      var t = i(0),
        ...
        T = {
          ...
          mobile: "(min-width: " + c + ") and (max-width: " + I + ")",
          tablet: "(max-width: " + I + ")",
          laptop: "(max-width: " + y + ")",
          laptopL: "(max-width: " + "1440px" + ")",
          desktop: "(min-width: " + y + ") and (max-width: " + w + ")",
          desktopL: "(max-width: " + w + ")"
        },
        o = g.a.div.withConfig({
        ...
        z = function(M) {
          var N = M.children;
          return e.a.createElement(o, null, N);
        },
        s = i(7),
        x = i.n(s),
        r = (i(154),
        ...
        C = function() {
          return e.a.createElement(
            r,
            null,
            e.a.createElement(l, null, "Richard Hamming on Luck"),
            e.a.createElement(
              E,
              null,
              e.a.createElement(
        ...
        d = (function(M) {
          ...
          return (
            ...
            (N.prototype.render = function() {
              return e.a.createElement(C, null);
            }),
            N
          );
        })(t.Component),
        A = function() {
          ...
          return e.a.createElement(
            ...
            null,
            M.map(function(M, N) {
              return e.a.createElement(d, { key: N });
            })
          );
        },
        m = g.a.div.withConfig({
        ...
        R = function(M) {
          var N = M.href,
            i = M.title,
            t = M.imgsrc,
            g = p()(M, ["href", "title", "imgsrc"]);
          return e.a.createElement(
            H,
            { target: "_blank", href: N },
            t ? e.a.createElement(P, Object.assign({ src: t }, g), i) : i
          );
        },
        V = function() {
          var M = [
        ...
        J = (function(M) {
          ...
          return (
            x()(N, M),
            (N.prototype.render = function() {
              return e.a.createElement(V, null);
            }),
            N
          );
        })(t.Component),
        W = g.a.div.withConfig({
        ...
        F = g.a.h1.withConfig({
          ...
          ["color:rgba(0,0,0,0.75);font-size:", ";margin:0 0 ", " 0;"],
          a(1.5),
          a(0.5)
        ),
        ...
        _ = function() {
          return e.a.createElement(
            W,
            null,
            e.a.createElement(F, null, "Dixit Keshavbhai Patel"),
            e.a.createElement("img", { src: S.a, alt: "Dixit" }),
            e.a.createElement(q, null, "just another software engineer"),
            e.a.createElement(J, null),
            e.a.createElement(
              K,
              null,
              "Made with ",
              e.a.createElement(X, null),
              " using",
              " ",
              e.a.createElement(
                "a",
        ...
        $ = (function(M) {
          ...
          return (
            x()(N, M),
            (N.prototype.render = function() {
              return e.a.createElement(_, null);
            }),
            N
          );
        })(t.Component);
...
//# sourceMappingURL=component---src-pages-index-js-7f2bd0faa1e05081585e.js.map
