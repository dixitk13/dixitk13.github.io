  ...
  [3],
  {
      ...
      var t = i(0),
        ...
        p = (function(M) {
          function N(N) {
            var i;
            return (
              ((i = M.call(this, N) || this).handleScroll = function() {
                i.setState({ y: window.scrollY });
              }),
              (i.themeToggle = function(M) {
                i.setState({ theme: M }), localStorage.setItem("theme", M);
              }),
              (i.state = {
                y: 0,
            ...
            (i.render = function() {
              ...
              return j.a.createElement(
                ...
                j.a.createElement(
                  ...
                  j.a.createElement(O, null, this.props.children)
                )
              );
            }),
            N
        ...
        uN = function(M) {
          ...
          return j.a.createElement(
            ...
            j.a.createElement(
              ...
              j.a.createElement(U, { dangerouslySetInnerHTML: { __html: e } }),
              j.a.createElement(
                v,
                null,
                I.map(function(M, N) {
        ...
        aN = (function(M) {
          ...
          return (
            ...
            (N.prototype.render = function() {
              return j.a.createElement(uN, this.props);
            }),
            N
          );
        })(t.Component),
        ...
        TN = (function(M) {
          ...
          return (
            ...
            (N.prototype.render = function() {
              var M = this;
              return j.a.createElement(zN.StaticQuery, {
                query: yN,
                render: function(N) {
                  return j.a.createElement(cN, {
        ...
        EN = (function(M) {
          ...
          return (
            e()(N, M),
            (N.prototype.render = function() {
              return j.a.createElement(rN, null);
            }),
            N
          );
        })(t.Component),
          ...
          return j.a.createElement(
            ...
            j.a.createElement(
              ...
              j.a.createElement(
                ...
                j.a.createElement("span", null, "Resume")
              )
            ),
            j.a.createElement(
              YN,
        ...
        ZN = (function(M) {
          ...
          return (
            e()(N, M),
            (N.prototype.render = function() {
              return j.a.createElement(m.Consumer, null, function(M) {
                var N = M.y;
                return j.a.createElement(vN, { y: N });
              });
            }),
            N
          );
        ...
        XN = (function(M) {
          ...
          return (
            e()(N, M),
            (N.prototype.render = function() {
              return j.a.createElement(VN, null);
            }),
            N
          );
        })(t.Component),
    ...
    150: function(M, N, i) {
      ...
      var c = j.a.createContext({}),
        n = function(M) {
          return j.a.createElement(c.Consumer, null, function(N) {
            return M.data || (N[M.query] && N[M.query].data)
              ? (M.render || M.children)(M.data ? M.data.data : N[M.query].data)
              : j.a.createElement("div", null, "Loading (StaticQuery)");
          });
        };
      function z() {
        throw new Error(
...
//# sourceMappingURL=component---src-pages-index-js-bf2b881060e319ea42d8.js.map
